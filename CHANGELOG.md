...
- Fix a bug concerning Audience Feed support: we were improperly returning `statusCode: 200` even when the Plugim impl. was returning `status: error` in its response.
