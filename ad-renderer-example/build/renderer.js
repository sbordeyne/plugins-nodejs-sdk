...
const fetch = {
    creative: (creativeId) => request('GET', `${outboundPlatformUrl}/v1/creatives/${creativeId}`),
    creativeProperties: (creativeId) => request('GET', `${outboundPlatformUrl}/v1/creatives/${creativeId}/renderer_properties`)
};
...
const getEncodedClickUrl = (redirectUrls) => {
